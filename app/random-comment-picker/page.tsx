      ...
      <div className="space-y-12 py-4">
        ...
        <section className="space-y-4 pt-4">
          ...
          <div className="p-6 bg-white border border-[#E8E7E3] space-y-4 text-[15px] text-[#383B40] leading-relaxed">
            ...
            <ul className="space-y-2.5 list-disc list-inside text-[#5B6169]">
              <li>
                <strong className="text-[#16181C]">Screen Record the Draw:</strong> Record your screen while clicking the &ldquo;Pick Random Winner Now&rdquo; button to share proof in your Community tab or next video.
              </li>
              <li>
                <strong className="text-[#16181C]">Set Clear Entry Criteria:</strong> Announce entry deadlines and any mandatory keywords clearly in your video description.
              </li>
              <li>
                <strong className="text-[#16181C]">Verify Winner Ownership:</strong> Check the winner&apos;s channel link and pin a verification comment under their winning post.
              </li>
            </ul>
          </div>
        </section>
