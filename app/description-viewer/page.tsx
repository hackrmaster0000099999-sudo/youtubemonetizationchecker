      ...
      <div className="space-y-12 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-5 bg-white border border-[#E8E7E3] space-y-2">
              <div className="flex items-center gap-2 font-semibold text-[#16181C]">
                <Clock className="w-4 h-4 text-[#D6293C]" />
            ...
            <div className="p-5 bg-white border border-[#E8E7E3] space-y-2">
              <div className="flex items-center gap-2 font-semibold text-[#16181C]">
                <Search className="w-4 h-4 text-[#1E9E6B]" />
        ...
        <section className="space-y-4 pt-4">
          ...
          <div className="p-6 bg-white border border-[#E8E7E3] space-y-4 text-[15px] text-[#383B40] leading-relaxed">
            ...
            <ul className="space-y-2.5 list-disc pl-5 text-[14px] text-[#5B6169]">
              <li>
                <strong className="text-[#16181C]">1. The Hook &amp; Primary Keywords (First 150 characters):</strong> Concise summary of the video topic that appears above the &quot;Show More&quot; fold in search results.
              </li>
              <li>
                <strong className="text-[#16181C]">2. Detailed Video Outline &amp; Chapters:</strong> Adding timestamps (e.g. <code>00:00</code>, <code>01:30</code>) enables Google Key Moments in Google Search results and improves retention.
              </li>
              <li>
                <strong className="text-[#16181C]">3. Resources, Gear &amp; Call-to-Actions (CTAs):</strong> Direct links to your newsletter, website, products, and social media channels.
              </li>
              <li>
                <strong className="text-[#16181C]">4. Relevant Hashtags:</strong> Adding 2 to 3 targeted hashtags (e.g. <code>#YouTubeSEO</code>) helps YouTube categorize your video within topic feeds.
              </li>
            </ul>
          </div>
        </section>
