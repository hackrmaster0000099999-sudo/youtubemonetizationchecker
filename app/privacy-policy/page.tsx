      ...
      <div className="space-y-8 py-4 max-w-[880px] mx-auto">
        ...
        <div className="p-8 tool-card-3d space-y-6 text-[15px] text-[#635B80] leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-[18px] font-bold text-[#181135]">1. Overview &amp; Commitment</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-[18px] font-bold text-[#181135]">2. Information We Do Not Collect</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-[18px] font-bold text-[#181135]">3. Information We Process Automatically</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-[18px] font-bold text-[#181135]">4. YouTube API Services &amp; Google Policies</h2>
            <p>
              ...
              <a
                ...
                className="text-[#7C3AED] underline hover:no-underline font-bold"
              >
          ...
          <section className="space-y-2">
            <h2 className="text-[18px] font-bold text-[#181135]">5. Cookies &amp; Tracking Technologies</h2>
            <p>
              YT MONETIZE does not utilize tracking cookies, third-party analytics pixels, or cross-site tracking scripts. Any browser local storage used is strictly functional (such as remembering your saved tool items or recent tool calculations during your visit).
            </p>
          </section>

          <section className="space-y-2">
            <h2 className="text-[18px] font-bold text-[#181135]">6. Updates to This Policy</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-[18px] font-bold text-[#181135]">7. Contacting Us</h2>
            <p>
              If you have questions regarding this Privacy Policy or our data handling practices, please submit an inquiry via our{' '}
              <Link href="/contact" className="text-[#7C3AED] underline hover:no-underline font-bold">
                Contact Page
              </Link>
              .
            </p>
