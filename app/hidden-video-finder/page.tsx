    ...
    <>
      ...
      <div className="space-y-12 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="tool-card-3d p-6 space-y-2">
              <div className="flex items-center gap-2 font-bold text-[#181135]">
                <ListVideo className="w-4 h-4 text-emerald-600" />
        ...
        <section className="space-y-4 pt-4">
          ...
          <div className="tool-card-3d p-6 space-y-3 text-[14px] text-[#635B80] leading-relaxed">
            <p>
              Many fraudulent websites and browser extensions claim to &quot;unlock&quot; or &quot;download&quot; private YouTube videos. In reality:
            </p>
            <ul className="space-y-2 list-disc pl-5">
              <li>
                <strong className="text-[#181135]">No third-party tool can bypass Google OAuth:</strong> YouTube’s streaming endpoints verify account credentials server-side before delivering video data packets.
              </li>
              <li>
                <strong className="text-[#181135]">Beware of malware and credential stealers:</strong> Never download unknown software or input your Google password into websites claiming to reveal private videos.
              </li>
              <li>
                <strong className="text-[#181135]">Our commitment to accuracy:</strong> We provide real, verifiable scanning of unlisted videos indexed in playlists while honestly reporting the true privacy state of protected items.
              </li>
            </ul>
          </div>
        </section>
