    ...
    >
      <div className="max-w-[1120px] mx-auto h-full px-4 sm:px-6 flex items-center justify-between">
        ...
        <nav id="desktop-nav" className="hidden lg:flex items-center gap-2 xl:gap-3">
          ...
          <div
            id="lang-indicator"
            className="hidden xl:flex items-center gap-1.5 text-[11px] font-mono-data font-bold text-[#635B80] border border-[#EDE8F9] px-2.5 py-1.5 rounded-xl bg-[#F3EEFE] whitespace-nowrap"
          >
